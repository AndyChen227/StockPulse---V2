...
| 7. Cloud readiness | Docker images, production configuration, authentication, durable datastore, secrets, logs, backups, cost controls | In progress: service and pinned-model daily Job images, full pipeline, PostgreSQL repository, and migration tooling implemented |
